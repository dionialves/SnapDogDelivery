...
import com.dionialves.snapdogdelivery.domain.admin.dashboard.dto.DashboardRecentOrderDTO;
...
public class DashboardService {
    ...
    public DashboardSummaryDTO getDashboardSummary() {
        ...
        summary.setNewCustomersToday(customerRepository.countByCreatedAt(today));
        summary.setNewCustomersYesterday(customerRepository.countByCreatedAt(yesterday));
