...
class ProductControllerTest {
    ...
    void search_retornaListaProdutos() throws Exception {
        var dto = new ProductResponseDTO(1L, "Hot Dog Clássico", new BigDecimal("15.90"),
                "Pão, salsicha, mostarda", null, true, false, null, null);
    ...
    void search_termoVazio_retornaTodos() throws Exception {
        var dto1 = new ProductResponseDTO(1L, "Hot Dog Clássico", new BigDecimal("15.90"), null, null, true, false, null, null);
        var dto2 = new ProductResponseDTO(2L, "X-Burguer", new BigDecimal("22.50"), null, null, true, false, null, null);
