...
import com.dionialves.snapdogdelivery.domain.admin.order.OrderViewController;
...
class OrderViewControllerTest {
    ...
    @BeforeEach
    void setUp() {
        // Evita erro de "circular view path" ao resolver nomes de view sem container
        // real
    ...
    @Test
    @DisplayName("POST /admin/orders/new sem customerId falha na validação e retorna formulário")
    void create_semCustomerId_retornaFormularioComErros() throws Exception {
        mockMvc.perform(post("/admin/orders/new")
                .param("products[0].productId", "1")
